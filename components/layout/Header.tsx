  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-4 lg:px-6 py-2 lg:py-3 flex items-center justify-between gap-x-6 relative">
          {/* LEFT: hamburger (mobile) + desktop icons/search */}
          <div className="flex items-center gap-x-2 md:gap-x-3">
            ...
            <div className="hidden lg:flex items-center gap-x-3">
              ...
              <button onClick={toggleTheme} className="text-gray-700 dark:text-gray-300 hover:text-[#D1A38A]">
              ...
              <div className="hidden lg:flex items-stretch border rounded-full overflow-hidden bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                ...
                />
                <button onClick={handleSearchSubmit} className="px-3 bg-[#d1a38a] text-white text-sm font-medium hover:bg-[#c19277] transition-colors">
          ...
          <nav className="hidden lg:flex items-center gap-x-8">
            {navLinks.map((link) => (
              <NavLink key={link.to} to={link.to} className="text-gray-700 dark:text-gray-300 hover:text-[#D1A38A] transition-colors pb-1 border-b-2 border-transparent" style={({ isActive }) => (isActive ? activeLinkStyle : {})}>
                {link.text}
              </NavLink>
            ))}
          </nav>

          {/* RIGHT: logo (absolute-centered on mobile) + mobile icons */}
          <div className="flex items-center gap-x-2 lg:gap-x-0">
            <Link to="/" className="font-display font-bold text-gray-800 dark:text-white text-2xl lg:text-3xl tracking-widest absolute left-1/2 -translate-x-1/2 lg:static lg:translate-x-0">
              MELORA
            </Link>
