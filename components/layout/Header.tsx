...
const Header: React.FC = () => {
  ...
  // لقياس ارتفاع الهيدر حتى لا يختبئ المحتوى تحته
  ...
  return (
    <>
      ...
      >
        {/* صف علوي للموبايل فقط: (سلة + EN + هلال) يسار, و MELORA + منيو يمين */}
        ...
        {/* شريط البحث في الموبايل فقط تحت الصف العلوي */}
        ...
        {/* صف الديسكتوب: يسار (سلة+EN+هلال+بحث) – وسط (الروابط) – يمين (MELORA) */}
