...
const baseProducts: Product[] = [
  ...
  },
  {
    ...
    description: {
      ...
      en: 'A luxurious oriental fragrance with the scent of aromatic sandalwood with a touch of spicy notes. Perfect for special occasions.',
    },
    details: {
  ...
  },
  {
    ...
    description: {
      ...
      en: 'A soft and sensual perfume with the touch of silk. Perfect for elegant occasions.',
    },
    details: {
  ...
  },
  {
    ...
    details: {
      ar: 'مكونات العطر: توابل، خشب الأرز، عنبر. الحجم: 100 مل. تركيز: أو دو برفوم.',
  ...
  {
    id: 'p14',
    name: { ar: 'عطر سكر الفانيلا', en: 'Vanilla Sugar Perfume' },
    category: 'perfumes',
    price: 80,
    rating: 4.9,
    reviewCount: 120,
    ...
    description: {
      ar: 'عطر فانيلا حلو كالسكر مع لمسة نهائية دافئة. مثالي للأيام الباردة.',
      en: 'A sweet vanilla perfume with a warm, creamy finish. Perfect for cold days.',
    },
    details: {
      ar: 'مكونات العطر: فانيلا، مسك، خشب الصندل. الحجم: 100 مل. تركيز: أو دو برفوم.',
      en: 'Notes: Vanilla, Musk, Sandalwood. Size: 100ml. Concentration: Eau de Parfum.',
  ...
  },
  {
    ...
    description: {
      ...
      en: 'A perfume from a garden of different spring flowers. Perfect for spring season.',
    },
    details: {
  ...
  },
  {
    ...
    description: {
      ar: 'عطر شرقي دافئ يذكرك بغروب الشمس في الصحراء. مثالي لفترات الصيف.',
      en: 'A warm eastern perfume that reminds you of the desert sunset. Perfect for summer evenings.',
    },
    details: {
      ar: 'مكونات العطر: توابل، خشب الأرز، مسك. الحجم: 100 مل. تركيز: أو دو برفوم.',
      en: 'Notes: Spices, Cedarwood, Musk. Size: 100ml. Concentration: Eau de Parfum.',
    },
    tags: ['new-arrival'],
  },
  {
    id: 'p17',
    name: { ar: 'عطر سحراء الليل', en: 'Midnight Magic Perfume' },
    category: 'perfumes',
    price: 90,
    rating: 4.7,
    reviewCount: 100,
    images: ['https://chatgpt.com/backend-api/estuary/content?id=file-MTgFg7hio2n1WBCrzJnmAQ&ts=489808&p=fs&cid=1&sig=9232baacfa05a04f6fca2a6b0e95d8310a2bc0a7e3e09c8f59c925acff93b503&v=0', 'https://picsum.photos/id/116/800/1000', 'https://picsum.photos/id/126/800/1000'],
    description: {
      ar: 'عطر سحري ليلي يضفي جواً من الغموض والسر.',
      en: 'A magical night perfume that envelops you in mystery and intrigue.',
    },
    details: {
      ar: 'مكونات العطر: خشب الصندل، مسك، زهور ليلية. الحجم: 100 مل. تركيز: أو دو برفوم.',
      en: 'Notes: Sandalwood, Musk, Night Flowers. Size: 100ml. Concentration: Eau de Parfum.',
    },
    tags: ['new-arrival'],
  },
  {
    id: 'p18',
    name: { ar: 'عطر سمراء الليل', en: 'Red Night Perfume' },
    category: 'perfumes',
    price: 85,
    rating: 4.8,
    reviewCount: 110,
    ...
    description: {
      ar: 'عطر سمراء كلاسيكي لليل. مثالي للمناسبات الرسمية.',
      en: 'A classic red night perfume for formal occasions.',
    },
    details: {
      ar: 'مكونات العطر: ورد أحمر، مسك، خشب الصندل. الحجم: 100 مل. تركيز: أو دو برفوم.',
      en: 'Notes: Red Rose, Musk, Sandalwood. Size: 100ml. Concentration: Eau de Parfum.',
    },
    tags: ['new-arrival'],
  },
  {
    id: 'p19',
    name: { ar: 'عطر ربيع ميلورا', en: 'Spring Blossom Perfume' },
    category: 'perfumes',
    price: 80,
    rating: 4.9,
    reviewCount: 125,
    ...
    description: {
      ar: 'عطر ربيعي منعش يجسد جمال أزهار الربيع المختلفة.',
      en: 'A refreshing spring perfume that captures the beauty of different spring flowers.',
    },
    details: {
      ar: 'مكونات العطر: زهور الربيع، خشب الصندل، مسك. الحجم: 100 مل. تركيز: أو دو برفوم.',
      en: 'Notes: Spring Flowers, Sandalwood, Musk. Size: 100ml. Concentration: Eau de Parfum.',
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 88,
    images: ['https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpJsNlhLfB4VbQJ8Eq9kmm53g11bbaHnWvTQ&s', 'https://picsum.photos/id/146/800/1000'],
    description: {
...
function generateProducts(category: 'perfumes' | 'makeup' | 'clothing', existingCount: number, targetCount: number, idPrefix: string): Product[] {
  ...
  for (let i = 1; i <= itemsToGenerate; i++) {
    ...
    // Generate review count between 50 and 200
    ...
    const product: Product = {
      ...
      description: {
        ar: `${category === 'perfumes' ? 'عطر فاخر' : category === 'makeup' ? 'منتج مكياج عالي الجودة' : 'منتج ملابس أنيق'} مثالي للاستخدام اليومي.`,
        en: `${category === 'perfumes' ? 'A luxurious perfume' : category === 'makeup' ? 'A high-quality makeup product' : 'An elegant clothing item'} perfect for daily use.`
      },
      details: {
        ar: `${category === 'perfumes' ? 'الحجم: 100 مل. تركيز: أو دو برفوم.' : 'مكونات عالية الجودة.'}`,
        en: `${category === 'perfumes' ? 'Size: 100ml. Concentration: Eau de Parfum.' : 'High-quality ingredients.'}`
      },
      tags: index % 3 === 0 ? ['new-arrival'] : index % 3 === 1 ? ['best-seller'] : index % 3 === 2 ? ['on-sale'] : []
    };
...
// Generate additional products to reach target counts
const perfumeProducts = generateProducts('perfumes', 4, 30, 'p');
const makeupProducts = generateProducts('makeup', 9, 30, 'm');
const clothingProducts = generateProducts('clothing', 3, 40, 'c');

// Combine base products with generated ones
export const products = [...baseProducts, ...perfumeProducts, ...makeupProducts, ...clothingProducts];